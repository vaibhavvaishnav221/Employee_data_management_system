...
This is a employee data management system where we will create a database named "warehouse" that shows the information of all the employees that are working in that specific warehouse and in that database, we wil create a table named employees that will have 3 columns at first named id, name and salary.
